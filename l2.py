...
class SimpleSwitch13(simple_switch_13.SimpleSwitch13):
    ...
    def port_stats_reply_handler(self, ev):
        body = ev.msg.body
        global tx_ini, aux, t, band, tx_fin
        print
...
class SimpleMonitor13(SimpleSwitch13):#herança do simpleswitch13
    def __init__(self, *args, **kwargs):
        super(SimpleSwitch13, self).__init__(self)#conexão necessaria para herdar a classe anterior
        self.datapaths = {}
        self.monitor_thread = hub.spawn(self._monitor)
    ...
    def _monitor(self):
        while True:
            ...
            hub.sleep(1) #0.25 exibirá 4/seg
